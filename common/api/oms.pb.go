...
func (x *ItemsWithQuantify) Reset() {
	*x = ItemsWithQuantify{}
	if protoimpl.UnsafeEnabled {
...
func (x *ItemsWithQuantify) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ItemsWithQuantify) ProtoMessage() {}

func (x *ItemsWithQuantify) ProtoReflect() protoreflect.Message {
	mi := &file_api_oms_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ItemsWithQuantify.ProtoReflect.Descriptor instead.
func (*ItemsWithQuantify) Descriptor() ([]byte, []int) {
	return file_api_oms_proto_rawDescGZIP(), []int{2}
}

func (x *ItemsWithQuantify) GetID() string {
	if x != nil {
		return x.ID
	}
	return ""
...
func (x *ItemsWithQuantify) GetQuantity() int32 {
	if x != nil {
		return x.Quantity
	}
	return 0
...
type CreateOrderRequest struct {
	...
	Items      []*ItemsWithQuantify `protobuf:"bytes,2,rep,name=Items,proto3" json:"Items,omitempty"`
}
...
func (x *CreateOrderRequest) GetItems() []*ItemsWithQuantify {
	if x != nil {
		return x.Items
	}
	return nil
...
var file_api_oms_proto_rawDesc = []byte{
	...
	0x73, 0x57, 0x69, 0x74, 0x68, 0x51, 0x75, 0x61, 0x6e, 0x74, 0x69, 0x66, 0x79, 0x12, 0x0e, 0x0a,
	...
	0x61, 0x6e, 0x74, 0x69, 0x66, 0x79, 0x52, 0x05, 0x49, 0x74, 0x65, 0x6d, 0x73, 0x32, 0x42, 0x0a,
	...
	0x6d, 0x74, 0x68, 0x65, 0x75, 0x73, 0x76, 0x61, 0x6c, 0x6c, 0x65, 0x2f, 0x63, 0x6f, 0x6d, 0x6d,
...
var file_api_oms_proto_goTypes = []interface{}{
	...
	(*Item)(nil),               // 1: api.Item
	(*ItemsWithQuantify)(nil),  // 2: api.ItemsWithQuantify
...
var file_api_oms_proto_depIdxs = []int32{
	...
	2, // 1: api.CreateOrderRequest.Items:type_name -> api.ItemsWithQuantify
...
func file_api_oms_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_api_oms_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ItemsWithQuantify); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
